...
We are using data from Hadley's paper. It's found at [github](https://github.com/hadley/tidyr). It'included in the course repository in directory `materials/lectures/Tidy/tidyr/vignettes`.
