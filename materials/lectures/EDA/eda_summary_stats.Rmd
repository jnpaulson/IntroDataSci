...
One last value of interest is the _inter-quartile range_ which is defined as the difference between the third and first quartile: $IQR = x_{(3n/4)} - x_{(1/4)}. The interpretation here is that half the data is within the IQR around the median.
