...
arrest_tab[seq(from=1,to=nrow(arrest_tab),by=2), ]
```
...
arrest_tab[arrest_tab$neighborhood == "Mount Washington",]
...
analyze_neighborhood <- function(neighborhood) {
  ...
  neighborhood_tab <- arrest_tab[neighborhood_tab,]
